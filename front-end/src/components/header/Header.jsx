  ...
  return (
    <div className='header section__padding'>
      <div className="header-content">
        <div>
          <h1>Create your AI NFTs and make a vote</h1>
      ...
      <div className="header-slider">
       ...
       <Slider {...settings} className='slider'>
            <div className='slider-card'>
              ...
              <p className='slider-card-price'>5.250 <span>SUI</span></p>
            </div>
            <div className='slider-card'>
              ...
              <p className='slider-card-price'>4.932 <span>SUI</span></p>
            </div>
            <div className='slider-card'>
              ...
              <p className='slider-card-price'>4.620 <span>SUI</span></p>
            </div>
            <div className='slider-card'>
              ...
              <p className='slider-card-price'>4.125 <span>SUI</span></p>
            </div>
            <div className='slider-card'>
              ...
              <p className='slider-card-price'>3.921 <span>SUI</span></p>
            </div>
            <div className='slider-card'>
              ...
              <p className='slider-card-price'>3.548 <span>SUI</span></p>
            </div>
        </Slider>
      </div>
    </div>
